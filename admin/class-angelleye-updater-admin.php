...
class AngellEYE_Updater_Admin {
    ...
    public function load_updater_instances() {
        ...
        new AngellEYE_Updater_Update_Checker();
    }
...
// End maybe_process_dismiss_link()
    ...
    public function maybe_display_activation_notice() {
        ...
        $products = $this->updater_helper->get_detected_products();
...
// End register_settings_screen()
    ...
    public function settings_screen() {
        ...
        switch ($screen) {
            ...
            default:
                if ($this->api->ping()) {
                    $this->installed_products = $this->updater_helper->get_detected_products();
...
// End process_request()
    ...
    protected function get_pending_products() {
        ...
        if (is_array($products) && ( 0 < count($products) )) {
            $activated_products = $this->updater_helper->get_activated_products();
...
// End get_pending_products()
    ...
    protected function activate_products($products) {
        ...
        $has_update = false;
        $already_active = $this->updater_helper->get_activated_products();
        $product_keys = $this->updater_helper->get_product_reference_list();
...
// End activate_products()
    ...
    public function ensure_keys_are_actually_active() {
        $products = (array) $this->updater_helper->get_activated_products();
    ...
    public function angelleye_get_plugin_list() {
        ...
        $response = array();
        $angelleye_activated_plugin_list = $this->updater_helper->get_activated_products();
